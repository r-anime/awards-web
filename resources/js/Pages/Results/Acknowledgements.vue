                ...
                <div class="container">
                    ...
                    <div v-for="acknowledgement in acknowledgements">
                        ...
                        <div class="columns mb-6">
                            <div class="column has-text-centered has-text-periwinkle is-align-items-center"
                                :style="'white-space: pre-wrap;'" v-text="acknowledgement.content.english"
                            />
                            <div v-if="acknowledgement.content.japanese" class="column has-text-centered has-text-periwinkle is-align-items-center"
